---
name: grill-me
description: Interview the user relentlessly about a plan or design until reaching shared understanding. Use when the user wants to be grilled, stress-test a plan, clarify a feature before PRD generation, or start the grill-to-spac workflow.
---
